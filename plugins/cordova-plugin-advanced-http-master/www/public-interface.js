module.exports = function init(
  ...
  var publicInterface = {
    ...
    getApproovLoggableToken: getApproovLoggableToken,
  ...
  function initializeApproov(success, failure) {
    exec(success, failure, "CordovaHttpPlugin", "initializeApproov");
  }
  ...
  function approovSetDataHashInToken(dataHash, success, failure) {
    exec(success, failure, "CordovaHttpPlugin", "approovSetDataHashInToken", [
      dataHash,
    ]);
  }

  function getApproovLoggableToken(host, success, failure) {
    const successCallback = (token) => {
      try {
        success(JSON.parse(token));
      } catch (e) {
        failure(e);
      }
    };
