...
// OkHttp release 3.14.0 deleted the long-deprecated OkUrlFactory API, which allows you to use the HttpURLConnection API
// with OkHttp's implementation. Cordova Advanced HTTP still needs OkUrlFactory and ObsoleteUrlFactory.java provides
// an identical API. It requires OkHttp 3.14 or newer. The original ObsoleteUrlFactory.java is located at:
// https://gist.github.com/swankjesse/dd91c0a8854e1559b00f5fc9c7bfae70, as linked from the changelog of OkHttp at:
